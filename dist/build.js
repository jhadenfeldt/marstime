...
var _julian = __webpack_require__(121);
...
var marstime = {
	getMSD: function getMSD(earthTime) {
		earthTime = (0, _moment2.default)(earthTime).toDate();
		return ((0, _julian2.default)(earthTime) - 2405522.0028779) / 1.0274912517;
	},
	getMTC: function getMTC(earthTime) {
